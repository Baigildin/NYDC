...
?>
    ...
    <div class="inner-banner reviews" style="background-image: url(<?=SITE_TEMPLATE_PATH;?>/img/reviewsbg1.png);">
      <div class="container">
        <h1>Reviews about the clinic</h1>
        <button class="btn" type="button" data-toggle="modal" data-target=".modal-review">Leave your review</button>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="filter-doctor">
                  <div class="headline">
                    <p class="title">Filter by doctors</p>
                  </div>
                  <div class="body-filter">
                    <ul>
                      <li>
                        <button class="specialist active" type="button" id="0">All reviews</button>
                      </li>
	...
	false
                  ...
                  <div class="more-btn">
                    <button class="btn" id="morereviews" type="button">More reviews</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            $(document).on("click", "#morereviews", function () {
                ...
                $.ajax(
                {
                  url: '/en/ajax/allReviews.php?PAGEN_1='+i,
                  type: 'post',
                  dataType: 'html',
                  success: function(data)
                  {
                    ...
                    $('#morereviews').remove();
                    if(count>3){
                      $('.more-btn').append('<button class="btn" id="morereviews" type="button">More reviews</button>');
                    }
                  }
                });
                i++;
            ...
            $(document).on('click', '.specialist', function() {
              ...
              if(id==0){
                ...
                $.ajax(
                {
                  url: '/en/ajax/allReviews.php?PAGEN_1='+k,
                  type: 'post',
                  dataType: 'html',
                  data: 'id='+id,
                  success: function(data)
                  {
                    ...
                    if(id>0){
                      if(specCount>0){
                        $('.more-btn').append('<button class="btn" id="specialist" type="button">More reviews</button>');
                      }
                    }else{
                        $('.more-btn').append('<button class="btn" id="morereviews" type="button">More reviews</button>');
                    }
