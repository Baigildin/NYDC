          ...
          <div class="item">
            ...
            <?$APPLICATION->IncludeComponent(
              ...
              array(
                ...
                "EDIT_TEMPLATE" => "",
                "PATH" => "/en/include/main/advantage1.php",
          ...
          <div class="item">
            ...
            <?$APPLICATION->IncludeComponent(
              ...
              array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/en/include/main/advantage2.php",
                "COMPONENT_TEMPLATE" => ".default"
              ),
              false
            );?>
          ...
          <div class="item">
            ...
            <?$APPLICATION->IncludeComponent(
              ...
              array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/en/include/main/advantage3.php",
                "COMPONENT_TEMPLATE" => ".default"
              ),
              false
            );?>
          ...
          <div class="item">
            ...
            <?$APPLICATION->IncludeComponent(
              ...
              array(
                ...
                "AREA_FILE_SUFFIX" => "inc",
                "EDIT_TEMPLATE" => "",
                "PATH" => "/en/include/main/advantage4.php",
                "COMPONENT_TEMPLATE" => ".default"
              ),
              false
            );?>
        ...
        <div class="item">
          <?$APPLICATION->IncludeComponent(
           ...
           array(
            ...
            "AREA_FILE_SUFFIX" => "inc",
            "EDIT_TEMPLATE" => "",
            "PATH" => "/en/include/main/aboutclinic.php",
            "COMPONENT_TEMPLATE" => ".default"
          ),
           false
         );?>
         <button class="btn" data-toggle="modal" data-target=".modal-callback-writetous" type="button">Write to us</button>
       </div>
     </div>
   </div>
 </div>
    ...
    <div class="row">
      <div class="col-lg-11 col-md-12">
        <div class="specialists-slider owl-carousel owl-theme">
          ...
          <a href="/en/spetsialisty/<?=$userSpec['id']?>" class="item">
          ...
          <?endforeach;?>
        </div><a class="btn" href="/en/spetsialisty">All specialists</a>
      </div>
    </div>
  </div>
</div>
<div class="services" style="background-image: url(<?=SITE_TEMPLATE_PATH?>/img/servicesimg.png);">
  <div class="container">
    <h2>Services</h2>
    <p class="subtitle">Personal assistance and advice</p>
    <div class="row pl">
      <div class="col-lg-11 col-md-12">
        <div class="row">
          <?$APPLICATION->IncludeComponent(
...
<div class="buttons">
  <button class="btn" data-toggle="modal" data-target=".modal-callback" type="button">Submit an application</button><a class="btn" href="/otzyvy">See all reviews</a>
</div>
</div>
</div>
</div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-writetous-send">
              <p class="title">To send a letter</p>
              <div class="group">
                <label>Your name</label>
                <input type="text" class="required" name="name">
              </div>
