        ...
        <div class="row pl">
          <div class="col-lg-11">
                                ...
                                <div class="select-box">
                                  <div class="select-box__current" tabindex="1">
                                    ...
                                    <div class="select-box__value">
                                      ...
                                      <p class="select-box__input-text">All specialties</p>
                                    </div>
                                  ...
                                  <ul class="select-box__list">
                                    <li>
                                      <label class="select-box__option" for="0" aria-hidden>All specialties</label>
                                    </li>
                                    <?foreach ($specialSelList as $specialSelK => $specialSel):?>
                                    <li>
            ...
            <div class="speciality-search">
                <input type="text" name="search" id="speciality-search" placeholder="Search for a doctor by full name">
            </div>  
            ...
            <div class="specialists-inner-wrapper">
                ...
                <?$k++;?>
                <?if($k==7)break;?>
                <a class="item" href="/en/spetsialisty/<?=$userSpec['id']?>">
            ...
            <div class="more-btn">
              <button class="btn" type="button">All specialists</button>
            </div>
          </div>
        </div>
      </div>
                ...
                $.ajax(
                {
                    ...
                    success: function(data)
                    {
                        ...
                        if(specialization == 'All specialties'){
                            ...
                            $('.more-btn').html('<button class="btn" type="button">All specialties</button>');
                        }
                    }
                });
            })
