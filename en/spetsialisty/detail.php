...
$APPLICATION->SetTitle("Specialists");?>
<?
...
$rsUser = CUser::GetByID($users[$page[3]]);
$userId = $rsUser->Fetch();
...
?>
              ...
              <div class="col-md-7">
                <div class="information">
                  <div class="information-scrolled">
                    ...
                    <h1><?=$user['name'];?></h1>
                    <p>Work experience: <?=$user['experience'];?></p>
                    <button class="btn" type="button" data-toggle="modal" data-target=".modal-callback">Make an appointment</button>
                  </div>
                  <?=$user['treatment'];?>
                  <?=$user['specdescr'];?>
                  ...
                  <div class="education">
                    ...
                    <button type="button" id="btn2" data-toggle="modal" data-target=".modal-diplom">See photos of diplomas</button>
                  </div>
                  <div class="works">
                    <p class="title">Doctor's work</p>
	...
	false
                    ...
                    <?if($cnt>3):?>
                    <button class="btn" id="btn3" type="button">More works</button>
                    <?endif;?>
                  </div>
	...
	false
                    ...
                    <div class="buttons">
                      <button class="btn" id="btn4" type="button" data-toggle="modal" data-target=".modal-send-callback">Submit an application</button><a class="btn" data-toggle="modal" data-target=".modal-review" href="#">Leave your review</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="title">Doctor's degrees</p>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="reviews" enctype="multipart/form-data">
              <p class="title">Leave your review</p>
              <div class="groups">
                <div class="group">
                  <label>Your name</label>
              ...
              <div class="files">
                <label>
                  ...
                  </svg><span>Drag and drop your photo or upload from your computer</span>
                  <input type="file" name="file">
                </label>
                <p>You can upload an image in JPG, GIF or PNG format.</p>
              </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="info">
              ...
              <p class="subtitle">Thank you, your opinion is important to us!</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      $(document).on("click", "#btn3", function () {
        ...
        $.ajax(
        {
          url: '/en/ajax/workExamplesSpecialists.php?PAGEN_1='+i,
          type: 'post',
          dataType: 'html',
          ...
          success: function(data)
          {
            ...
            $('#btn3').remove();
            if(count>3){
              $('.works').append('<button class="btn" id="btn3" type="button">More works</button>');
            }
          }
        });
        i++;
