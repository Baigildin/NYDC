...
<head>
  ...
  <body>
    ...
    <header>
      <div class="container">
        <div class="wrapper"><a class="logo" href="/"><img src="<?=SITE_TEMPLATE_PATH?>/img/logo.png"></a>
	...
	false
          ...
          <div class="lang dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="<?=$section;?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/rus.png"><span>RU</span></a>
              <a class="dropdown-item" href="/en<?=$section;?>"><img src="<?=SITE_TEMPLATE_PATH?>/img/eng.png"><span>EN</span></a>
            </div>
          </div>
    ...
    <div class="fixed">
      <div class="container">
        <div class="sidebar">
          <ul>
            <li><a <?if($section=='/'){echo 'class="active"';}?> href="/">
            ...
            <li><a <?if($section=='/spetsialisty/'){echo 'class="active"';}?>href="/spetsialisty/">
                <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
            ...
            <li><a <?if($section=='/uslugi-i-tseny/'){echo 'class="active"';}?>href="/uslugi-i-tseny/">
                <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
            ...
            <li><a <?if($section=='/otzyvy/'){echo 'class="active"';}?>href="/otzyvy/">
                <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
            ...
            <li><a <?if($section=='/kontakty/'){echo 'class="active"';}?>href="/kontakty/">
                <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
