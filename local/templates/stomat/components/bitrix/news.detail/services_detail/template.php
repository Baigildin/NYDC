  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-10 col-md-12">
        <div class="links">
          <p>Нажмите на любую интересующую услугу:</p>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-11 col-md-12">
        ...
        <p>Ввод номера телефона подтверждает ваше согласие c <a href='#'>условиями передачи информации</a></p>
      </div>
    </div>
  </div>
</div>
<?$APPLICATION->IncludeComponent(
 ...
 array(
  ...
  "EDIT_TEMPLATE" => "",
  "PATH" => "/include/uslugi-i-tseny/detail/NYDC.php",
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-11 col-md-12">
       ...
       <div class="buttons">
        <button class="btn" data-toggle="modal" data-target=".modal-callback" type="button">Отправить заявку</button><a class="btn" href="#">Смотреть все отзывы</a>
      </div>
    </div>
  </div>
</div>
