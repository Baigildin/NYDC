...
$selectUsers = implode('|', $arResult['PROPERTIES']['SPECIALIZATION']['VALUE']);
$rsUsers = CUser::GetList($by='id', $order='asc',Array('GROUPS_ID' => Array(6), 'ID' => $selectUsers),Array());
...
$arResult['SPECIALIZATION'] = $userLists;
?>